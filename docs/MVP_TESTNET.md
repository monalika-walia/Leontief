...
| Wallet | Wrapped | Collateral (ldLEOD) | Debt (USDC) | Health |
|---|---|---|---|---|
| `GCCDH7TXDEXCQZOCP7WTNV2MHSQOUSU736J6IRGZ5MPLJCNISGNMVYZD` | 4,000 LEOD | 4,083.60 | 2,000.00 | 1.76 |
| `GA4PG5M3WIIYYXKOQFTAZ6IINT7TKSNHHAD62AL32F4S3Q4IRBCL5XMB` | 2,000 LEOD | 2,041.80 | 900.00 | 1.96 |
...
| Action | Wallet | Tx |
|---|---|---|
| wrap LEOD → ldLEOD | `GA4PG5M3…5XMB` | `d949809da5f50dcdded62c5e1931036d0d34ea18f6cad1a3bcf7266a0d57aacd` |
| supply collateral | `GCCDH7TX…VYZD` | `46173ce0f16444a70f4e4cd77fcfda4db8a7e8ccdfab68302330e9dd6ff6d577` |
| borrow USDC | `GCCDH7TX…VYZD` | `bc213ad650277731583a5fa5b468520f1dd28be627fff0fb6e9c3ef35caecf2c` |
| supply collateral | `GA4PG5M3…5XMB` | `f1eac5d3810a20076a5cd46a0c0b3f6ee2d77e3c2ed52a042c69512660dc2ccb` |
| borrow USDC | `GA4PG5M3…5XMB` | `a0d567f0b0e9cdb7a9739ea35dd650a32e7db39ae227df846c61159ed59477cb` |
| NAV tick (+1.5%) | oracle admin | `c11c26fbff1b8c34a1f560d39a6d04319f7b4b1f4643edc69ad650153b2d04eb` |
